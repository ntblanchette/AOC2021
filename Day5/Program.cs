...
var mapper = new LineContentDay5Mapper();
var contentBreaker = new ContentBreaker<LineContentDay5>(mapper);
var calculator = new Day5Calculator();

var content = fileReader.GetFileContentAsList("Day5.txt");
